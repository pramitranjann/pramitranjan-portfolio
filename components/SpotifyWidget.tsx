    ...
    <div style={{ background: '#111111', border: '1px solid #1f1f1f', padding: '14px' }}>
      ...
      <div className="flex" style={{ gap: '10px', alignItems: 'center' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div className="font-serif" style={{ fontSize: '15px', fontStyle: 'italic', color: '#f5f2ed', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
            {track.title}
          </div>
          <div className="font-mono" style={{ fontSize: '10px', letterSpacing: '0.1em', color: '#999999', marginTop: '3px' }}>
