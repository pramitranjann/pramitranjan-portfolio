...
export default function AtomPage() {
  return (
    <CaseStudyLayout
      ...
      problem="Atom OS redesigns the smartphone experience by removing distractions and replacing them with four intentional widgets: Books, Meditation, Focus, and a To-Do List. The goal was to make the phone feel deliberately limited — not broken, just focused."
      ...
      challenge="I explored what a 'dumb phone' mode could look like without sacrificing utility. Early explorations focused on widget hierarchy and colour — settling on black and white to psychologically reduce the pull of the screen."
      process="Kept micro-interactions minimal by design. The colour gradient in the screen time dashboard was used to signal which apps help vs. harm, without being prescriptive. Focus mode was made user-configured, not automatic, to preserve autonomy."
      ...
      outcomes="Atom OS taught me that subtraction is a design decision. The hardest part wasn't adding features — it was deciding what to withhold. I'd revisit the onboarding flow to help users understand the philosophy before they start using it."
