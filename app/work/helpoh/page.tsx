...
export default function HelpOHPage() {
  return (
    <CaseStudyLayout
      ...
      problem="HelpOH is a service-to-doorstep platform designed for Malaysia's rapidly growing economy. It connects users with vetted professionals for household and personal services, while providing workers with legal protections, training, and consistent income."
      ...
      process="Green and white palette was chosen deliberately to evoke trust and familiarity. The booking flow — service, location, date, time — was kept to a single surface to minimise friction and build confidence in first-time users."
      ...
      outcomes="HelpOH pushed me to design for two very different users simultaneously. The worker-side of the platform deserved more screen time than I gave it — in a next iteration, I'd build out a dedicated worker dashboard with job management and training access."
