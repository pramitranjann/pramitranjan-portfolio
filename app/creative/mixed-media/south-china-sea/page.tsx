...
export default function SouthChinaSeaPage() {
  return (
    <CaseStudyLayout
      ...
      problem="A large-scale mixed media installation exploring the South China Sea conflict through the lens of public naivety. Presented as a detective board, the piece draws on cyanotypes, photograms, coffee-aged maps, and original photography to connect geopolitics to lived experience."
      ...
      outcomes="The detective board format was the right call — it let viewers discover connections rather than be told them. I'd invest more in the sound or ambient dimension of the installation if revisiting. The piece lived very much in the visual; there's a version of it that also hits the body."
